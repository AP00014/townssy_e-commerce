...
export default function ProfileModal({ isOpen, onClose, variant = "auto" }) {
  const { signUp, signIn, signOut, isAuthenticated, user, profile, isAdmin, isSuperAdmin, loading: authLoading } = useAuth();
      ...
      <div className="profile-menu-list">
        {(isAdmin || isSuperAdmin) && (
          <a href="/admin" className="menu-item admin-menu-item">
            ...
            <span className="admin-badge-small">{isSuperAdmin ? 'Super' : 'Admin'}</span>
          </a>
        )}
